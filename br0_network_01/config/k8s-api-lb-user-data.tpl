...
runcmd:
  ...
  - nmcli connection modify eth0 +ipv4.routes "10.17.4.0/24 ${hosts_ip}"
  - nmcli connection modify eth0 +ipv4.routes "10.17.5.0/24 ${hosts_ip}"
  - nmcli connection modify eth0 +ipv4.routes "10.17.3.0/24 ${hosts_ip}"
