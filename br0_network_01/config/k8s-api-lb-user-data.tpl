...
runcmd:
  ...
  - nmcli connection modify eth0 +ipv4.routes "10.17.4.0/24 192.168.0.40"
  - nmcli connection modify eth0 +ipv4.routes "10.17.5.0/24 192.168.0.40"
  - nmcli connection modify eth0 +ipv4.routes "10.17.3.0/24 192.168.0.40"
