...
runcmd:
  ...
  - sudo ip route add 10.17.3.0/24 via 192.168.0.19 dev eth0
  - sudo ip route add 10.17.4.0/24 via 192.168.0.19 dev eth0
  - sudo ip route add 10.17.5.0/24 via 192.168.0.19 dev eth0
